...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item link \emph{torna su}, sotto forma di bottone circolare sempre visibile, che si trova a lato del content: se invocato, ti porta all'inizio del content. 
		...
		\item il menù rispetta la convenzione dei colori delle ancore. Infatti ogni link del menù è di colore blu, e diventa
		...
		Solo i link nascosti nei bottoni, tutti uguali, non rispettano le convenzioni in quanto sono facilmente riconoscibili.
		\item non è stato necessario l'utilizzo di \emph{tabindex}, in quanto viene seguito in modo preciso il DOM (Document Object Model).
	\end{itemize}
