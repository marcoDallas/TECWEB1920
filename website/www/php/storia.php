...
echo(Print_content::header('Dietro ad una grande pasticceria, c\'è anche una grande tradizione')."\r");
...
?>
    <div id="content" class="large_column" role="article">
            ...
            <img class="imgStoria" src="../images/pasticceria/storia_1.jpg" alt=""/>
            <p>
            ...
            <img class="imgStoria" src="../images/pasticceria/storia_2.jpg" alt=""/>
            <p>
            ...
            <img class="imgStoria" src="../images/pasticceria/storia_3.jpg" alt=""/>
            <p>
