...
$content = str_replace('<file_to_insert/>','<img src="'.$path.'" alt=""><div class="input_line"><label for="image">Cambia immagine: </label><input name="image" type="file" id="image"/></div>',$content);
